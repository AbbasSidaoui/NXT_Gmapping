...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_6d().pack(_x.calibration_offset.x, _x.calibration_offset.y, _x.calibration_offset.z, _x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.calibration_offset.x, _x.calibration_offset.y, _x.calibration_offset.z, _x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z,) = _get_struct_6d().unpack(str[start:end])
      start = end
      end += 72
