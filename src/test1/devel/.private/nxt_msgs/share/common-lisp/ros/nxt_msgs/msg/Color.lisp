...
(cl:defmethod cl:initialize-instance :after ((m <Color>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Color)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nxt_msgs-msg:<Color> is deprecated: use nxt_msgs-msg:Color instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Color>))
...
(cl:defmethod intensity-val ((m <Color>))
...
(cl:defmethod r-val ((m <Color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nxt_msgs-msg:r-val is deprecated.  Use nxt_msgs-msg:r instead.")
  (r m))

(cl:ensure-generic-function 'g-val :lambda-list '(m))
(cl:defmethod g-val ((m <Color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nxt_msgs-msg:g-val is deprecated.  Use nxt_msgs-msg:g instead.")
  (g m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <Color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nxt_msgs-msg:b-val is deprecated.  Use nxt_msgs-msg:b instead.")
  (b m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Color>)))
  ...
  "a62a6387c4711f26d641ffa6e12a86e8")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Color)))
  "Returns md5sum for a message object of type 'Color"
  "a62a6387c4711f26d641ffa6e12a86e8")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Color>)))
  ...
  (cl:format cl:nil "Header header~%float64 intensity~%float64 r~%float64 g~%float64 b~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Color)))
  "Returns full string definition for message of type 'Color"
  (cl:format cl:nil "Header header~%float64 intensity~%float64 r~%float64 g~%float64 b~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
